...
<h1 className= 'text-center mt-5 pb-3 fw-bold'>OUR EXPERT<span className ='text-warning'>  TRAINERS</span></h1>
  ...
  <div className="col">
    <div className="card h-100">
      ...
      <div className="card-body">
        ...
        <p className="card-text" style={{color:'tomato'}}>Fitness Trainer</p>
