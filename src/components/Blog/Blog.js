...
<div className="row row-cols-1 row-cols-md-3 g-4 pb-3">
  <div className="col">
    <div className="card h-100">
      ...
      <div className="card-body">
        <h5 className="card-title fw-bold" style={{color:'tomato'}}>BEST GYM IN PATNA</h5>
  ...
  <div className="col">
    <div className="card h-100">
      ...
      <div className="card-body">
        <h5 className="card-title fw-bold" style={{color:'tomato'}}>BEST GYM IN KANKARBAGH PATNA</h5>
  ...
  <div className="col ">
    <div className="card h-100">
      ...
      <div className="card-body">
        <h5 className="card-title fw-bold" style={{color:'tomato'}}>BEST STRENGTH TRAINING GYM IN PATNA</h5>
